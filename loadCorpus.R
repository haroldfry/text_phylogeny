...
loadCorpus <- function(corpus) {
   ...
   # corpus <- "/Users/bingyushen/Downloads/text-phylogeny-src/Code/generated_corpus_1052.10/" 
   # corpusList <- dir("/Users/bingyushen/Downloads/text-phylogeny-src/Code/generated_corpus_1052.10/", full.names = TRUE)
   # for F_* features
   corpusStemmed <- c()
